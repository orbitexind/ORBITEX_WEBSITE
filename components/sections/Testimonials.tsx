...
const testimonials = [
  {
    ...
    stars: 5,
    text: "Satvik built our business website in just 4 days. The design is modern, loads super fast, and our clients keep complimenting it. He was responsive on WhatsApp throughout and delivered exactly what we discussed. Will definitely hire again!",
  ...
  },
  {
    ...
    stars: 5,
    text: "I needed a complete college project with documentation and presentation in a week. Satvik delivered a fully working Android app with clean code and all documents. He explained every part so I could present it confidently. Highly recommended for college projects!",
  ...
  },
  {
    ...
    stars: 5,
    text: "I wanted a simple Android app for my shop to manage inventory and orders. Satvik built it in a week at a very affordable price. Even after delivery he helped me with a few small changes without any extra charge. Very professional and reliable.",
  ...
  },
  {
    ...
    stars: 5,
    text: "We needed an AI chatbot for our customer support that could answer queries in both English and Marathi. Satvik understood our requirement perfectly and delivered a smart, working chatbot in just 10 days. Our team is saving hours every week now.",
  ...
  },
  {
    ...
    stars: 5,
    text: "Satvik helped me build a complete data analysis dashboard for my internship project in Python. The visualizations were excellent and my manager was impressed. He also explained the code clearly so I could present it myself. Great value for money!",
